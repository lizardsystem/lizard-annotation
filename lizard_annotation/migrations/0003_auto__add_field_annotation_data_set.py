...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lizard_annotation_annotation', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Annotation.data_set'
        db.delete_column('lizard_annotation_annotation', 'data_set_id')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'data_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_security.DataSet']", 'null': 'True', 'blank': 'True'}),
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 16, 11, 45, 28, 14470)'}),
